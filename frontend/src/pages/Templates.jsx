...
// Same voice-formula concept as the Composer's "Tone" picker (see
// styleTemplate there) — kept as one TEMPLATES list so the two stay in sync,
// rather than as "templates" in the layout sense Designs.jsx means by it.
const TEMPLATES = [
...
export default function Templates() {
  ...
  return (
    <div data-testid="templates-page">
      <div className="font-mono text-xs uppercase tracking-[0.25em] text-zinc-500">Batch</div>
      <h1 className="mt-2 font-display text-4xl font-semibold tracking-tight">Drop a topic, get a week of posts</h1>

      <label className="mt-7 block font-mono text-[11px] uppercase tracking-[0.15em] text-zinc-500">Tone</label>
